...
\begin{proof}
	...
	\end{align*}
\end{proof}
Ovvero se conosco la funzione di massa di probabilità sono in grado di calcolare della funzione di ripartizione. 
Andiamo a vedere tuttavia il contrario:
A partire dalla funzione di partizione riusciamo a dire qualcosa sulla funzione di massa di probabilità?
\begin{equation*}
	F_x \rightarrow P_x
	\end{equation*}
...
\subsubsection{Indipendenza tra variabili aleatore congiunte}
